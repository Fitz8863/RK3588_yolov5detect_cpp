...
这里提供了C++版本的yolov5线程池推理的代码，我已经把全部要用到的动态库环境一同放到此项目中，所以无需去安装opencv已经RKNN等各种环境，拉下即可直接编译运行。这里提供了两个版本的代码，分别是Ubuntu20.04和Ubuntu22.04，你需要根据吧开发板自身的系统去拉取对应的代码，保证开发板的系统和仓库的系统版本一致。
